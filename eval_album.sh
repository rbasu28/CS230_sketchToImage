...
export MODEL=trainedModels/rupam.pth.tar

export TEST_PHOTO=/Users/minglirui/train_data/album_covers_512
export TEST_PHOTO=album_photos

python evaluate_album.py --model $MODEL --test_photos_dir $TEST_PHOTO --test_sketches_dir album_sketches --num_images 5 --num_sketches 20 --batch_size 2 --output output
