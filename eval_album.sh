...
python evaluate_album.py --model $MODEL --test_photos_dir $TEST_PHOTO --test_sketches_dir album_sketches --num_images 5 --num_sketches 3 --batch_size 2 --output output
